...
export const newDailyDetail = async (employeeDailyDetailsData) => {
    try {
        ...
        const docRef = await addDoc(collection(db, "employeeDailyDetails"), employeeDailyDetailsData);
        console.log("New employeeDailyDetails entered into the system with ID: ", docRef.id);
        return docRef.id;
    } catch (error) {
...
export const updateemployeeDailyDetails = async (employeeDailyDetailsId, employeeDailyDetailsData ) => {
    try {
        const employeeDailyDetailsRef = doc(db, "employeeDailyDetails", employeeDailyDetailsId);
        ...
        console.error("Error updating Price Card employeeDailyDetails: ", error.message);
        throw error;
    }
};
...
export const getemployeeDailyDetailsById =  async (employeeDailyDetailsId) => {
    try {
        ...
        if (employeeDailyDetailsSnapshot.exists()) {
            const employeeDailyDetails = { id: employeeDailyDetailsSnapshot.id, ...employeeDailyDetailsSnapshot.data() };
